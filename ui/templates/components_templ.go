...
func ActionButton_NewChat() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 8, "<div id=\"action_button_container\"><button onclick=\"if(window._activeCall){window._activeCall.close();window._activeCall=null}if(window.peer){window.peer.destroy();}var r=document.querySelector('#remote_video');if(r)r.srcObject=null;\" id=\"action_button\" class=\"border bg-chatopia-1 border-chatopia-3 text-white p-1 md:p-2 font-light hover:bg-chatopia-1/80 text-sm md:text-lg\" type=\"button\" ws-send hx-vals='{\"message_type\":\"new_connection\"}' hx-trigger=\"click\">New Chat</button></div>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
...
func InterestPill(interest string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `ui/templates/components.templ`, Line: 129, Col: 12}
		}
